...
SELECT OEHR_EMPLOYEES.EMPLOYEE_ID AS "COD_TRABAJADOR",
    CONCAT(OEHR_EMPLOYEES.FIRST_NAME,CONCAT(' ',OEHR_EMPLOYEES.LAST_NAME)) AS "NOMBRE", 
    OEHR_JOBS.JOB_TITLE AS "CARGO",
    OEHR_DEPARTMENTS.DEPARTMENT_NAME AS "DEPARTAMENTO"
